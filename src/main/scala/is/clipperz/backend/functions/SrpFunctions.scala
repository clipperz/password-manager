...
trait SrpFunctions:
  ...
  def computeSecretServer (aa: BigInt, b: BigInt, v: BigInt, u: BigInt): BigInt
  def computeSecretClient (aa: BigInt, b: BigInt, v: BigInt, u: BigInt): BigInt
  def computeU (aa: Array[Byte], bb: Array[Byte]): Task[Array[Byte]]
  def computeV (x: BigInt): BigInt
  def computeM1 (c: Array[Byte], s: Array[Byte], aa: Array[Byte], bb: Array[Byte], kk: Array[Byte]): Task[Array[Byte]]
  def computeM2 (aa: Array[Byte], m1: Array[Byte], kk: Array[Byte]): Task[Array[Byte]]
  def computeK (ss: BigInt): Task[Array[Byte]]

object SrpFunctions:
  val baseConfiguration: SRPConfigV6a = SRPConfigV6a(SRPGroup.group1024, HexString("7556AA045AEF2CDD07ABAF0F665C3E818913186F").toBigInt, hashSHA256, kdfSHA256)
  ...
  case class SrpFunctionsV6a(configuration: SRPConfigV6a = baseConfiguration) extends SrpFunctions:
    ...
    override def computeSecretServer (aa: BigInt, b: BigInt, v: BigInt, u: BigInt): BigInt =
      val nn  = this.configuration.group.nn
      (aa * (v.modPow(u, nn))).mod(nn).modPow(b, nn)
    
    override def computeSecretClient (bb: BigInt, x: BigInt, a: BigInt, u: BigInt): BigInt =
      val nn  = this.configuration.group.nn
      val g  = this.configuration.group.g
      val k  = this.configuration.k
    ...
    override def computeM1 (c: Array[Byte], s: Array[Byte], aa: Array[Byte], bb: Array[Byte], kk: Array[Byte]): Task[Array[Byte]] =
      val nn  = this.configuration.group.nn
      val g   = this.configuration.group.g
      for {
    ...
    override def computeM2 (aa: Array[Byte], m1: Array[Byte], kk: Array[Byte]): Task[Array[Byte]] =
