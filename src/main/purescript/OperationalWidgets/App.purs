...
import Views.AppView (CardManagerEvent, LoginFormData, LoginPageEvent(..), LoginType(..), MainPageEvent(..), Page(..), PageEvent(..), SignupPageEvent(..), UserAreaEvent, WidgetState(..), appView, emptyLoginFormData)
...
executeOperation (MainPageEvent (CardManagerEvent event)) = handleCardManagerEvent event
executeOperation (MainPageEvent (UserAreaEvent    event)) = handleUserAreaEvent    event
