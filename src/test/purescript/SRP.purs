...
srpSpec =
  describe "SRP" do
    ...
    it computesA do
      let a  = fromMaybe bigInt0 (toBigInt $ hex "60975527 035CF2AD 1989806F 0407210B C81EDC04 E2762A56 AFD529DD DA2D4393")
      let aa = fromMaybe bigInt0 (toBigInt $ hex $ "61D5E490 F6F1B795 47B0704C 436F523D D0E560F0 C64115BB 72557EC4"
    ...
    it computesB do
      let b = fromMaybe bigInt0 (toBigInt $ hex "E487CB59 D31AC550 471E81F0 0F6928E0 1DDA08E9 74A004F4 9E61F5D1 05284D20")
      let v = fromMaybe bigInt0 (toBigInt $ hex $ "7E273DE8 696FFC4F 4E337D05 B4B375BE B0DDE156 9E8FA00A 9886D812"
                                              <> "9BADA1F1 822223CA 1A605B53 0E379BA4 729FDC59 F105B478 7E5186F5"
                                              <> "C671085A 1447B52A 48CF1970 B4FB6F84 00BBF4CE BFBB1681 52E08AB5"
                                              <> "EA53D15C 1AFF87B2 B9DA6E04 E058AD51 CC72BFC9 033B564E 26480D78"
                                              <> "E955A5E2 9E7AB245 DB2BE315 E2099AFB")
      let bb = fromMaybe bigInt0 (toBigInt $ hex $ "BD0C6151 2C692C0C B6D041FA 01BB152D 4916A1E7 7AF46AE1 05393011"
    ...
    it computesSClient do
      let ss = fromMaybe bigInt0 (toBigInt $ hex $ "B0DC82BA BCF30674 AE450C02 87745E79 90A3381F 63B387AA F271A10D"
      ...
      let bb = fromMaybe bigInt0 (toBigInt $ hex $ "BD0C6151 2C692C0C B6D041FA 01BB152D 4916A1E7 7AF46AE1 05393011"
                                              ...
                                              <> "37089E6F 9C6059F3 88838E7A 00030B33 1EB76840 910440B1 B27AAEAE"
                                              <> "EB4012B7 D7665238 A8E3FB00 4B117B58")
      let x = fromMaybe bigInt0 (toBigInt $ hex "94B7555A ABE9127C C58CCF49 93DB6CF8 4D16C124")
      let u = fromMaybe bigInt0 (toBigInt $ hex "CE38B959 3487DA98 554ED47D 70A7AE5F 462EF019")
