...
object UserSpec extends ZIOSpec[SessionManager]:
  ...
  val indexCardContent = HexString("")
  val indexCardReference = HexString("f23cb992df6fe7cbe747ec43dd4d033c086d80608f94ce8929da1c5fc647890f")

  val testSignupData = SignupData(testUser, 
                               indexCardReference,
                               indexCardContent,
                               Array[(HexString, HexString)]())

  val testUser2 = UserCard(c, 
                          HexString("0bedc30aca36a67fcc8a7d5d81e72c0dcf10fd20cd8d03f0bbb788807304c3b6"), 
                          HexString(""), 
                          "6a", 
                          "2.0", 
  ...
  val testUserDifferentC = UserCard(HexString("aaaaa"), 
                          HexString("0bedc30aca36a67fcc8a7d5d81e72c0dcf10fd20cd8d03f0bbb788807304c3b6"), 
                          HexString(""), 
                          "6a", 
                          "1.0", 
  ...
  def preparePost(c: String, signupData: String, session: Boolean)=     
    Request(
      url = URL(!! / "users" / c),
      method = Method.POST,
  ...
  def preparePut(c: String, signupData: String, session: Boolean): Request =     
    Request(
      url = URL(!! / "users" / c),
      method = Method.PUT,
      headers = if (session) Headers((SessionManager.sessionKeyHeaderName, sessionKey)) else Headers.empty,
  ...
  def prepareSession(c: String): ZIO[SessionManager, Throwable, Unit] =
    ZIO
      ...
      .flatMap(sessionManager => 
        sessionManager.saveSession(Session(sessionKey, Map(("c", c))))
      )
      .map(_ => ())
      ...
      for {
        ...
        res <- app(prepareGet(c.toString(), true)).flatMap(result =>
            if result.status.code == 200 then
              ...
              ZIO.succeed(assertNever(s"Wrong GET result code: ${result.status.code}"))
          ) 
