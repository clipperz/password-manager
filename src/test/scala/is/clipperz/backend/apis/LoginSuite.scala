...
*/
    ...
    val app =  (loginApi).handleErrorCauseZIO(customErrorHandler).toHttpApp
    ...
    def makeLoginRequest(step: String)(c: String, stepData: String, withSession: Boolean) =
        Request(
            url = URL(Root / "api" / "login" / step / c),
            method = Method.POST,
    ...
    def loginRequestStep1(c: String, stepData: String, withSession: Boolean): Request = makeLoginRequest("step1")(c, stepData, withSession)
        // Request(
    ...
    def loginRequestStep2(c: String, stepData: String, withSession: Boolean): Request = makeLoginRequest("step2")(c, stepData, withSession)
        // Request(
