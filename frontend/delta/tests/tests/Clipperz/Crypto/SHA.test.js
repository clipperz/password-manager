...
var testHashFunction = function (aValue, anExpectedResult, hashFunction) {
	var byteArrayValue;
	var hashValue;
	
	byteArrayValue = new Clipperz.ByteArray(aValue);
	hashValue = hashFunction(byteArrayValue);
	is(anExpectedResult, hashValue.toHexString(), "hash(' " + aValue + "')");
//	is(anExpectedResult, hashValue.toHexString(), "hash(' " + byteArrayValue.toHexString() + "')");
}

var testSHA1 = function (aValue, anExpectedResult) {
	testHashFunction(aValue, anExpectedResult, Clipperz.Crypto.SHA.sha1);
}

var testSHA256 = function (aValue, anExpectedResult) {
	testHashFunction(aValue, anExpectedResult, Clipperz.Crypto.SHA.sha256);
}
...
var tests = {
	...
	'basic_tests': function (someTestArgs) {
		testSHA256('', '0xe3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855');
		testSHA256('0xbd', '0x68325720aabd7c82f30f554b313d0570c95accbb7dc4b5aae11204c08ffe732b');
		testSHA256('0x5fd4', '0x7c4fbf484498d21b487b9d61de8914b2eadaf2698712936d47c3ada2558f6788');
		testSHA256('0xc98c8e55', '0x7abc22c0ae5af26ce93dbb94433a0e0b2e119d014f8e7f65bd56c61ccccd9504');
		testSHA256('0x0df1cd526b5a4edd', '0x47f527210d6e8f940b5082fec01b7305908fa2b49ea3ae597c19a3986097153c');
		testSHA256('0xfdf4700984ee11b70af1880d0e0fefd4', '0xb01ae16eed3b4a770f127b98469ba26fe3d8e9f59d8a2983214afe6cff0e6b6c');
		testSHA256('0x8cf53d90077df9a043bf8d10b470b144784411c93a4d504556834dae3ea4a5bb', '0x56059e8cb3c2978b198208bf5ca1e1ea5659b737a506324b7cec75b5ebaf057d');
		testSHA256('0xeebcf5cd6b12c90db64ff71a0e08ccd956e170a50dad769480d6b1fb3eff4934cde90f9e9b930ee637a66285c10f4e8a', '0xc117b9dce689c399ec99008788cd5d24d8396fab7d96315c4f3fe6d56da63bb3');
		testSHA256('0x3592ecfd1eac618fd390e7a9c24b656532509367c21a0eac1212ac83c0b20cd896eb72b801c4d212c5452bbbf09317b50c5c9fb1997553d2bbc29bb42f5748ad', '0x105a60865830ac3a371d3843324d4bb5fa8ec0e02ddaa389ad8da4f10215c454');
	...
	'aldo_cortesi_tests': function (someTestArgs) {
		testSHA256('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',	'0xa3f01b6939256127582ac8ae9fb47a382a244680806a3f613a118851c1ca1d47');
		testSHA256('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',	'0xb35439a4ac6f0948b6d6f9e3c6af0f5f590ce20f1bde7090ef7970686ec6738a');
		testSHA256('0x79',														'0xa1fce4363854ff888cff4b8e7875d600c2682390412a8cf79b37d0b11148b0fa');
		testSHA256('0x80',														'0x76be8b528d0075f7aae98d6fa57a6d3c83ae480a8469e668d7b0af968995ac71');
	},
	...
	'longTextPerformance_test': function (someTestArgs) {
		...
		startTime = new Date();
		testSHA256(longText, '0xf6fac13c06784e0fbc61a3d25c41c9984840a8b617a2beb57cf6fa3e5e4a8949');
		endTime = new Date();
	...
	'sha1_testVectors': function (someTestArgs) {
		testSHA1('The quick brown fox jumps over the lazy dog',	'0x2fd4e1c67a2d28fced849ee1bb76e7391b93eb12');
		testSHA1('The quick brown fox jumps over the lazy cog',	'0xde9f2c7fd25e1b3afad3e85a0bd17d9b100db4b3');
		testSHA1('The quick brown fox jumps over the lazy cat',	'0xf99cf75b4d3e9d76ce38a2d0cc88f23ae9e6b505');
		testSHA1('',											'0xda39a3ee5e6b4b0d3255bfef95601890afd80709');
	},
	
	//-------------------------------------------------------------------------

	'aldo_cortesi_tests_sha1': function (someTestArgs) {
		testSHA1('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',		'0xb05d71c64979cb95fa74a33cdb31a40d258ae02e');
		testSHA1('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',	'0xc2db330f6083854c99d4b5bfb6e8f29f201be699');
		testSHA1('0x79',														'0x95cb0bfd2977c761298d9624e4b4d4c72a39974a');
		testSHA1('0x80',														'0xc78ebd3c85a39a596d9f5cfd2b8d240bc1b9c125');
	},
